...
> **Snapshot: 2026-07-27 · matrix at 8/24.**
...
| **Experiment** | Slides 6–8 | "How do you know it's a star?" "Why 8/24?" |
...
| | | Where it comes from |
|---|---|---|
| ⭐ **8 / 24** | M4 runs collected | `run_matrix.py --status` |
...
1. **Matrix at 8/24** — remaining work is runtime, not method
