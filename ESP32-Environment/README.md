...
[`docs/_archive/guides/README-Part2.md`](docs/_archive/guides/README-Part2.md)
if you want the step-by-step `idf.py` commands without the menu — note it
...
- Golden rules, troubleshooting, and the attack/topology runbooks

The original manual Part 2 (`idf.py` commands only, no menu, predates `-Location`) is
archived at [`docs/_archive/guides/README-Part2.md`](docs/_archive/guides/README-Part2.md).
