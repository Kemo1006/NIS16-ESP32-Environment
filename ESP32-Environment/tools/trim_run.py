...
─────
    cd tools
    python trim_run.py exports/baseline/linear                          # report
    python trim_run.py exports/baseline/linear --apply                  # -> .../trimmed/
    python trim_run.py exports/baseline/linear --apply --in-place
...
def main():
    ...
    p.add_argument("directory", nargs="?",
                   help="Folder of exported CSVs (e.g. exports/baseline/linear)")
