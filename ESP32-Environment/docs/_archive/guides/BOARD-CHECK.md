...
[`LINEAR-RUNBOOK.md`](../runbooks/LINEAR-RUNBOOK.md#-quick-troubleshooting).
...
- [`tools/trim_run.py`](../../tools/trim_run.py) — strip reboot sessions from an exported CSV
  ([why](../runbooks/LINEAR-RUNBOOK.md#-trimming-exports-before-analysis))
- [`LINEAR-RUNBOOK.md`](../runbooks/LINEAR-RUNBOOK.md#-quick-troubleshooting) — the shared troubleshooting table
- [`ARCHIVE-RUNBOOK.md`](../runbooks/ARCHIVE-RUNBOOK.md) — tuck a finished run away safely
