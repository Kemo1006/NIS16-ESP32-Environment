...
>
> Companion flat command lists live in [`ATTACKS-Commands.md`](../guides/ATTACKS-Commands.md).
> The per-attack deep dives are [`BASELINE-SETUP.md`](../setups/BASELINE-SETUP.md),
> [`BLACKHOLE-SETUP.md`](../setups/BLACKHOLE-SETUP.md), [`WORMHOLE-SETUP.md`](../setups/WORMHOLE-SETUP.md).
>
